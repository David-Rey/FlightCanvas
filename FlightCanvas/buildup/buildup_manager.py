...
class BuildupManager:
    ...
    def compute_buildup(self):
        ...
        if self.smooth_data:
            sigma_to_tune = 4
            self.asb_data_static["CL"] = scipy.ndimage.gaussian_filter(self.asb_data_static["CL"], sigma=sigma_to_tune)
            self.asb_data_static["CY"] = scipy.ndimage.gaussian_filter(self.asb_data_static["CY"], sigma=sigma_to_tune)
            self.asb_data_static["CD"] = scipy.ndimage.gaussian_filter(self.asb_data_static["CD"], sigma=sigma_to_tune)
            self.asb_data_static["Cl"] = scipy.ndimage.gaussian_filter(self.asb_data_static["Cl"], sigma=sigma_to_tune)
            self.asb_data_static["Cm"] = scipy.ndimage.gaussian_filter(self.asb_data_static["Cm"], sigma=sigma_to_tune)
            self.asb_data_static["Cn"] = scipy.ndimage.gaussian_filter(self.asb_data_static["Cn"], sigma=sigma_to_tune)
